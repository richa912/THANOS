...
**_Data explanation is as following_**
...
**_After preparing the tree, token , and vocab file we are ready to feed this data to train our model. Below are the steps_**
